...
$$
    Q_N = \lim_{m \to \infty} \prod_{n=N}^m B_n 
$$
exists. In this case, we define $\prod_{n=1}^\infty B_n = Q_N \prod_{n=1}^{N-1} B_n$. 

Following @Trench1999, we say that the product $\prod_{n=1}^\infty B_n$ converges _invertibly_ if for all $n \ge N$, $B_n$ is invertible and the product $Q_N$ defined above is invertible as well.  It was argued in @Trench1999 that the above definition has the following consequences:
